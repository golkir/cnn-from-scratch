...
print (tr_set.shape, test_set.shape)
...
print (tr_labels.shape, test_labels.shape)
...
def forwardprop(image,cache):
	...
	print(cache['C2']['sigmoid'].shape, 'C2 sigmoid shape')
...
def backprop(cache, example, labels):
	...
	print(dL_dSoftmax, 'Gradient of loss w.r.t to Softmax')
	...
	print (dL_dF6_parameters.shape, 'F6 parameters gradient')
	...
	print(dL_dF6_biases.shape, 'F6 bias gradient')
	...
	print (dL_dF6.shape, 'Gradient of loss w.r.t to layer F6 inputs')
	...
	print (dF6_dS3_sigmoid.shape, 'C3 Sigmoid derrivative')
	...
	print(dL_dS3_sigmoid.shape, 'Gradient of loss w.r.t C3 sigmoid')
	...
	print (dL_dC3.shape, 'Gradient of loss with respect to C3 input')
	...
	print(dL_dS2_maxpool[0], 'C2 Maxpool derivative')
	...
	print (dL_dC2_parameters[0].shape, 'Gradient of loss w.r.t C2 filters/parameters')
	print (dL_dC2_parameters[1].shape, 'Gradient of loss w.r.t C2 filters/parameters')
	print (dL_dC2_parameters[2].shape, 'Gradient of loss w.r.t C2 filters/parameters')
	print (dL_dC2_parameters[3].shape, 'Gradient of loss w.r.t C2 filters/parameters')
	...
	print (dL_dC2_biases, 'Gradient of loss w.r.t to C2 bias')
	...
	print(dC1_dS1_sigmoid, 'Gradient of C1 S1 Sigmoid with respect to its input')
	print (dC1_dS1_sigmoid.shape)
	...
	print(dL_dS1_sigmoid, 'Gradient of loss w.r.t to C1 sigmoid')
	print(dL_dS1_sigmoid.shape, 'Gradient of loss w.r.t to C1 sigmoid')
	...
	print (dL_dS1_maxpool.shape, 'Gradient of loss w.r.t to C1 S1 subsampling layer')
	print(dL_dS1_maxpool[0], 'Gradient of loss w.r.t to C1 S1 subsampling layer ')
	...
	print (dL_dC1_parameters, 'Gradient of loss w.r.t to C1 filters')
	...
	print (dL_dC1_biases, 'Gradient of loss w.r.t to C1 biases')
...
def update_weights (grads_params, grads_biases,cache, lr):
	...
	print(grads_params[3].shape, 'Shape of F6 grad')
...
def train (training_set, labels, batch_size, epochs):
	...
	for epoch in range(epochs):
		...
		for minibatch in range(len(minibatches_X)):
			...
			print(avg_grad_params.shape, 'Shape of average grad parameters')
			print(avg_grad_biases.shape, 'Shape of average grad biases')
